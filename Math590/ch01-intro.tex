...
\dfn{Inclusion Map}{
	Let $X$ be a topological space, and $Y\subset X$. We call $i:Y\to X$ defined by the rule $y\mapsto y$. Then the subspace topology on $Y = \{U\cap Y| U\subset X\}$ where $U\cap Y = i^{-1}(U)$. So the subspace topology $\{i^{-1}(U)| U\subset X \text{ is open}\}$. This is the coarsest topology that makes $i$ continuous.
}
