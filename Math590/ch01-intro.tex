...
\begin{myproof}
	...
	$(\impliedby)$ Assume $\forall x\in\mathbb{R}^d,\forall\epsilon > 0,\exists\delta < 0$ such that $f(B(x,\delta))\subset B(f(x),\epsilon)$. Let $U\subset\mathbb{R}^d$ be open. Then, for $f$ to be continuous we want to show that $f^{-1}(U) is open. Let $x\in f^{-1}(U)$
\end{myproof}
