...
\dfn{The (Standard) Inner Product and (Standard) Norm}{Let $\textbf{x} = (x_1,...,x_d), \textbf{y}=(y_1,...,y_d)\in\mathbb{R}$. The standard inner product is a map $f:\mathbb{R}^d\times\mathbb{R}^d\to\mathbb{R}$ defined by
